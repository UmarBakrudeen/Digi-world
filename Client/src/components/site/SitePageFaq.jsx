              ...
              <div className="row">
                <div className="faq__section-column col-12 col-lg-6">
                  <div className="typography">
                    <h6>How I sell my product on souqarena?</h6>

                    <p>
                      First you have click on starting selling button available
                      on website button area. And you will see contact us field.
                      You have to fill that area. After few days souqarena will
                      contact You.
                    </p>

                    <h6>Which type a product can I sell on souqarena?</h6>
                ...
                <div className="faq__section-column col-12 col-lg-6">
                  <div className="typography">
                    <h6>How much does it cost to sell on souqarena?</h6>
                    ...
                    <h6>How can I buy from souqarena?</h6>
