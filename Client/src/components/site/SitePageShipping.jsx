              ...
              <div className="row">
                <div className="faq__section-column col-12 col-lg-12">
                  <div className="typography">
                    ...
                    <p>
                      souqarena an Ecommerce marketplace radical the
                      orthodox methods of buying and selling things in our
                      country. Through souqarena customer can buy and
                      sale their product in modern way by using souqarena
                      website. souqarena is convincing a lot of daily
                      deals to our proactive customers. Deals like discounts in
                      products. souqarena an imagines Ecommerce market
                      place radical the orthodox methods of buying and selling
                      thing in our country. souqarena is convincing a lot
                      of daily deals to our proactive customers Deals like
                      discounts in products.
                    </p>
                    <h3>Free and same day/next day delivery</h3>
                    <p>
                      souqarena is contributing free and same Delivery to
                      ...
                      <br />
                      The fantastic part for customers in souqarena is
                    ...
                    <p>
                      souqarena provides different types of grocery
